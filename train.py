...
parser.add_argument('--initial-checkpoint', default='', type=str, metavar='PATH',
                    ...
                    #'/home/amin/models/pytorch-image-models-master/output/train/20200707-190652-gluon_resnet101_v1d-224/model_best.pth.tar'
parser.add_argument('--resume', default=None, type=str, metavar='Path',
                    help='Resume full model and optimizer state from checkpoint (default: none)')
parser.add_argument('--no-resume-opt', action='store_true', default=False,
                    help='prevent resume of optimizer state when resuming model')
parser.add_argument('--num-classes', type=int, default=4795, metavar='N',
...
parser.add_argument('--lr-noise-pct', type=float, default=0, metavar='PERCENT',
                    help='learning rate noise limit percent (default: 0.67)')
parser.add_argument('--lr-noise-std', type=float, default=0, metavar='STDDEV',
...
parser.add_argument('--decay-epochs', type=float, default=41, metavar='N',
