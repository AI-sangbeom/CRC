...
parser.add_argument('--num-classes', type=int, default=4795,
...
def validate(args):
    ...
    labels = [i for i in range(3413)]
    lists = [[] for _ in range(3413)]
    y_true = dict(zip(labels, lists))
    with torch.no_grad():
        for i, (input, target) in enumerate(loader):
            ...
            for num, label in enumerate(target.tolist()):
                label = int(label)
                y_true[label].append(pred[num])
            ...
            yy_pred = yy_pred + list(pred)
            yy_true = yy_true + target.tolist()
            # print(yy_pred)
            # print(yy_true)
            # return
    ...
    print("F1-score :", f1_score(yy_true, yy_pred, average=None))
    print("F1-score(micro) :", f1_score(yy_true, yy_pred, average='micro'))
    print("F1-score(macro) :", f1_score(yy_true, yy_pred, average='macro'))
    print("F1-score(weighted) :", f1_score(yy_true, yy_pred, average='weighted'))
